...
class QuestionCopy extends React.Component {
  constructor(props) {
    super(props);
    ...
    // this.fetchData(props.route.params.id);
  }
  ...
  fetchData(id) {
    fetch(
      `http://43.136.22.129:3000/api/question/show/${id}?type=json&relation_type=question&relation_user_id=TlzPsHCm6g5R8h6UCT5fxQHFoEqDa3sC`
    )
